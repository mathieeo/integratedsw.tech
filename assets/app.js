/* ============================================================================
   ...
   The app catalog lives in assets/apps.js (shared with the static generator).
   This script reads the global APPS it defines and renders the homepage.
   ============================================================================ */
...
function openApp(i){
  ...
  const pageLink = a.slug ? `<a class="chip more" href="apps/${a.slug}/">Open app page ↗</a>` : '';
  mpanel.innerHTML = `
    ...
    <div class="mlinks">${store}${pageLink}</div>
    ${gallery}`;
