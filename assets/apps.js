...
const APPS = [
  ...
  // heroShot:2 → 01.png here is a marketing/headline composite (≈3:4), not a
  // plain device screenshot; the phone mockups need the ≈9:19.5 raw shot at 02.
  { name:"Tunnel", cat:"Developer Tools", accent:"#22d3ee", icon:"Tunnel", key:"tunnel", slug:"tunnel", heroShot:2,
  ...
  { name:"NetScan Pro", cat:"Utilities", accent:"#34d399", icon:"NetScanPro", key:"netscan", slug:"netscan", heroShot:2,
  ...
  { name:"DepthTag", cat:"Utilities", accent:"#38bdf8", icon:"DepthTag", key:"depthtag", slug:"depthtag", heroShot:2,
  ...
  { name:"SnapSweep", cat:"Photo & Video", accent:"#0ea5e9", icon:"SnapSweep", key:"snapsweep", slug:"snapsweep", heroShot:2,
  ...
  { name:"DoughRatio", cat:"Food & Drink", accent:"#f59e0b", icon:"DoughRatioApp", key:"doughratio", slug:"doughratio", heroShot:2,
  ...
  { name:"Score Split", cat:"Sports", accent:"#ef4444", icon:"ScoreSplit", key:"scoresplit", slug:"scoresplit", heroShot:2,
